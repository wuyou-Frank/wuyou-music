			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
                        <label for="cmid" class="col-sm-2 control-label">分类编号</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="cmname" class="col-sm-2 control-label">风格名字</label>
                        <div class="col-sm-10">
...
<script src="/wuyou_Music/js/admin/community/list.js"></script>
</body>
</html>