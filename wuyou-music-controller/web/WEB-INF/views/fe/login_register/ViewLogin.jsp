...
<div class="login-form">
	...
	<div class="avtar">
		<img src="/wuyou_Music/images/login/avtar.png" />
			...
			<form action="/wuyou_Music/view/login" method="post">
					<input type="text" class="text" value="Username" name="lname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" >
						<div class="key">
						<input type="password" value="Password" name="lpassword" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
						</div>
						<div>
